...
export function NotificationBell() {
  ...
  return (
    <Link
      ...
      className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-on-surface-variant transition-colors hover:bg-surface-container-high hover:text-on-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
      href="/notifications"
    >
      ...
      {unreadCount > 0 && (
        <span className="absolute right-1.5 top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-error px-1 text-label-sm font-bold text-white">
    ...
    <div className="group relative">
      ...
      >
        ...
        <div className="hidden min-w-0 flex-col items-start lg:flex">
          <span className="max-w-[120px] truncate text-label-md font-semibold leading-4 text-on-surface">
            {displayName}
          </span>
          <span className="text-label-sm leading-4 text-on-surface-variant">
            {displayRole}
          </span>
        </div>
        <span
      ...
      <div
        ...
        role="menu"
        className="pointer-events-none absolute right-0 top-full z-50 mt-2 min-w-[200px] rounded-lg border border-outline-variant bg-surface-container-lowest opacity-0 shadow-sm transition-all group-focus-within:pointer-events-auto group-focus-within:opacity-100 group-hover:pointer-events-auto group-hover:opacity-100"
        tabIndex={-1}
      >
