...
/**
 * v11.1.6 Replay Debugger - List Page
 *
 * Shows all completed sandbox sessions with quick access to replay.
 */
  ...
  return (
    <div className="p-margin-desktop space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="font-display-lg text-display-lg text-on-surface mb-2">Replay Debugger</h1>
          <p className="text-body-md text-on-surface-variant">
            Phát lại quá trình tối ưu hóa từng bước
          </p>
        </div>

        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => router.push("/digital-twin/live")}>
      ...
      <section>
        <h2 className="font-headline-md text-headline-md text-on-surface mb-4">
          Phiên có thể replay ({completedSessions.length})
        </h2>
        ...
        {loading ? (
          ...
          <div className="p-12 bg-surface-container-lowest border border-outline-variant rounded-xl text-center">
            <span className="material-symbols-outlined text-[48px] text-on-surface-variant">replay</span>
            <h3 className="mt-4 font-title-lg text-title-lg text-on-surface">Chưa có phiên nào hoàn thành</h3>
            <p className="mt-2 text-body-md text-on-surface-variant">
              Chạy một mô phỏng và hoàn thành để có thể replay
            </p>
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-label-xs text-on-surface-variant">Runtime</div>
                    </div>
                  </div>
