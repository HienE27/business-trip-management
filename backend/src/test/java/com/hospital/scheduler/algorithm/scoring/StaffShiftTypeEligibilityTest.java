 ...
 * <ul>
 *   <li>L01/L02/L03 chỉ gán Bác sĩ / Điều dưỡng</li>
 *   <li>L04 với specialty: chỉ staff cùng chuyên khoa</li>
 *   <li>L04 không có specialty: mặc định Bác sĩ / Điều dưỡng</li>
 * </ul>
 */
class StaffShiftTypeEligibilityTest {
    ...
    void inactiveStaff_neverEligible() {
        Staff doc = staff(1, specialty(1, "Bác sĩ"), false);
    ...
    void eligibleStaffIdsForNonL04_excludesIneligibleSpecialties() {
        ...
        Staff pha = staff(3, specialty(3, "Dược sĩ"), true);
        Staff tech = staff(4, specialty(4, "Kỹ thuật viên"), true);
        Staff inactive = staff(5, specialty(1, "Bác sĩ"), false);
    ...
    void getL04EligibilityBySpecialty_groupsCorrectly() {
        Staff doc1 = staff(1, specialty(1, "Bác sĩ"), true);
        Staff doc2 = staff(2, specialty(1, "Bác sĩ"), true);
        Staff nur1 = staff(3, specialty(2, "Điều dưỡng"), true);
        ...
        assertThat(map.get(3)).containsExactly(4);
